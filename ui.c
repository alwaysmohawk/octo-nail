...
void ui_event_Slider2( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
if ( event_code == LV_EVENT_VALUE_CHANGED) {
      _ui_slider_set_text_value( ui_actual, target, "", "");
}
}
void ui_event_Button2( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
...
ui_octonailLabel = lv_label_create(ui_home_);
...
ui_Slider2 = lv_slider_create(ui_home_);
lv_slider_set_range(ui_Slider2, 120,360);
lv_slider_set_value( ui_Slider2, 1, LV_ANIM_OFF);
if (lv_slider_get_mode(ui_Slider2)==LV_SLIDER_MODE_RANGE ) lv_slider_set_left_value( ui_Slider2, 340, LV_ANIM_OFF);
...
lv_obj_set_style_bg_color(ui_Slider2, lv_color_hex(0xECF41A), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_bg_opa(ui_Slider2, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_shadow_color(ui_Slider2, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_FOCUSED );
lv_obj_set_style_shadow_opa(ui_Slider2, 255, LV_PART_MAIN| LV_STATE_FOCUSED);
lv_obj_set_style_shadow_width(ui_Slider2, 4, LV_PART_MAIN| LV_STATE_FOCUSED);
lv_obj_set_style_shadow_spread(ui_Slider2, 6, LV_PART_MAIN| LV_STATE_FOCUSED);

lv_obj_set_style_bg_color(ui_Slider2, lv_color_hex(0x2C1AF4), LV_PART_INDICATOR | LV_STATE_DEFAULT );
lv_obj_set_style_bg_opa(ui_Slider2, 255, LV_PART_INDICATOR| LV_STATE_DEFAULT);

lv_obj_set_style_bg_color(ui_Slider2, lv_color_hex(0xF316F3), LV_PART_KNOB | LV_STATE_DEFAULT );
lv_obj_set_style_bg_opa(ui_Slider2, 255, LV_PART_KNOB| LV_STATE_DEFAULT);

ui_Button2 = lv_btn_create(ui_home_);
...
lv_obj_set_style_bg_color(ui_Button2, lv_color_hex(0xFF00F7), LV_PART_MAIN | LV_STATE_DEFAULT );
...
lv_obj_set_style_shadow_width(ui_Button2, 4, LV_PART_MAIN| LV_STATE_FOCUSED);
lv_obj_set_style_shadow_spread(ui_Button2, 6, LV_PART_MAIN| LV_STATE_FOCUSED);
...
lv_obj_add_flag( ui_Screen1, LV_OBJ_FLAG_HIDDEN );   /// Flags
